...
public class PetShop implements Serializable{
	...
	private synchronized void xulie() throws IOException{
	...
	public synchronized void check1(DataOutputStream out) throws IOException {//¹· -1 -1 -1
	...
	public synchronized void add(String data) {//¹· ¿Ö¾åÄ§Íõ ×Ï 2222
	...
	public synchronized void check(String data, DataOutputStream out) throws IOException {//¹· -1 -1 -1
	...
	public synchronized void modify(String value, String data) throws IOException {//-1 -1 -1
		{
	...
	public synchronized void delete(String value, DataOutputStream out) throws IOException {//¹· -1 -1 -1
